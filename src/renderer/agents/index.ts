...
import { agyModule } from './agy/index';
import { claudeModule } from './claude/index';
import { codexModule } from './codex/index';
import { grokModule } from './grok/index';
import { opencodeModule } from './opencode/index';

export const AGENT_MODULES: AgentModule[] = [claudeModule, codexModule, agyModule, grokModule, opencodeModule];
