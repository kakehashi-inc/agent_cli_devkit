                ...
                <TableBody>
                    {entries.map(entry => {
                        ...
                        const relText = relPart
                            ? t(
                                  `grok.assetManager.relative.${relPart.key}`,
