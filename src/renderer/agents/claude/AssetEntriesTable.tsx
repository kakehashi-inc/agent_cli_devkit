...
import type { AssetEntry } from '@shared/agents/claude/types';
                ...
                <TableBody>
                    {entries.map(entry => {
                        ...
                        const relText = relPart
                            ? t(
                                  `claude.assetManager.relative.${relPart.key}`,
                        ...
                        return (
                            <TableRow key={entry.relPath} hover>
                                        ...
                                        {(recent || relText) && (
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mt: 0.5 }}>
                                                {recent && (
                                                    ...
                                                    >
                                                        {t('claude.assetManager.newBadge')}
                                                    </Box>
                                                )}
                                                {relText && (
                                                    <Box
                                ...
                                >
                                    ...
                                    >
                                        {t('claude.assetManager.viewHeader')}
                                    </Button>
                                    {onViewFull && (
                                        <Button
                                            size='small'
                                        ...
                                        >
                                            {t('claude.assetManager.viewFull')}
                                        </Button>
                                    )}
                                </TableCell>
                            </TableRow>
